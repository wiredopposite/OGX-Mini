...
static const hid_usage_map_t HID_USAGE_MAP_SWITCH = {
    .buttons = {
        [HID_USAGE_BUTTON_01] = GAMEPAD_BTN_BIT_X,
        [HID_USAGE_BUTTON_02] = GAMEPAD_BTN_BIT_A,
        [HID_USAGE_BUTTON_03] = GAMEPAD_BTN_BIT_B,
        [HID_USAGE_BUTTON_04] = GAMEPAD_BTN_BIT_Y,
        [HID_USAGE_BUTTON_05] = GAMEPAD_BTN_BIT_LB,
        [HID_USAGE_BUTTON_06] = GAMEPAD_BTN_BIT_RB,
        [HID_USAGE_BUTTON_07] = GAMEPAD_BTN_BIT_LT,
        [HID_USAGE_BUTTON_08] = GAMEPAD_BTN_BIT_RT,
        [HID_USAGE_BUTTON_09] = GAMEPAD_BTN_BIT_BACK,
        [HID_USAGE_BUTTON_10] = GAMEPAD_BTN_BIT_START,
        [HID_USAGE_BUTTON_11] = GAMEPAD_BTN_BIT_L3,
        [HID_USAGE_BUTTON_12] = GAMEPAD_BTN_BIT_R3,
        [HID_USAGE_BUTTON_13] = GAMEPAD_BTN_BIT_SYS,
        [HID_USAGE_BUTTON_14] = GAMEPAD_BTN_BIT_MISC,
