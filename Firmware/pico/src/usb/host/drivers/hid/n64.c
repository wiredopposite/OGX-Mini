...
static const hid_usage_map_t HID_USAGE_MAP_N64 = {
    .buttons = {
        ...
        [HID_USAGE_BUTTON_02] = GAMEPAD_BIT_NONE,
        ...
        [HID_USAGE_BUTTON_07] = GAMEPAD_BIT_A,
        [HID_USAGE_BUTTON_08] = GAMEPAD_BIT_NONE,
        [HID_USAGE_BUTTON_09] = GAMEPAD_BIT_B,
...
static bool n64_button_quirk_cb(uint8_t usage, uint32_t value, gamepad_pad_t* pad, 
    ...
    case HID_USAGE_BUTTON_08:
        pad->buttons |= (value ? GP_BIT(profile->btn_rt) : 0);
        return true;
    default:
        break;
    }
