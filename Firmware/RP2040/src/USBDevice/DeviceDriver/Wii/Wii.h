...
/** Stub Wiimote driver for Pico W/2W Wii mode.
 * Controller is on PIO USB host; BT is used for Wiimote link to the Wii.
 * process() can be extended to send gamepad state to a Wiimote BT stack. */
class WiiDevice : public DeviceDriver
{
public:
